...
<!-- Site wrapper -->
  ...
  <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Admón Facultades</h3>
                </div>
                <div class="card-body">
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="nuevo()">Crear</button>
                    <table id="facultades_data" class="table display responsive wrap">
                        <thead>
                            <tr>
                                <th>Código</th>
                                <th>Descripción</th>
    ...
    <!-- /.Site warapper -->
    <?php require_once("admFacultadesModal.php"); ?>
    <?php include("modulos/js.php"); ?>
    <script type="text/javascript" src="js/admFacultades.js"></script>
</body>
</html>
<?php
  }else{
