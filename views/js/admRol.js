...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "/Voluntariado/controller/rol.php?opc=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function(){
    $('#rol_data').DataTable({
        ...
        "ajax":{
            url:"/Voluntariado/controller/rol.php?opc=listar",
            type:"post"
        },
        "bDestroy": true,
        "responsive": true,
...
function editar(rol_id){
    $.post("/Voluntariado/controller/rol.php?opc=mostrar",{rol_id:rol_id},function (data){
...
function eliminar(rol_id){
    Swal.fire({
        ...
        if(result.value){
            $.post("/Voluntariado/controller/rol.php?opc=eliminar",{rol_id:rol_id},function (data){
                $('#rol_data').DataTable().ajax.reload();
                Swal.fire({
                    title: 'Correcto!',
